...
hubs[[2]] <- c(
  "APP", "STXBP1", "GOT2", "GNAS", "SQSTM1", "WASF1", "CNTNAP1", "PDXK", "NEFM",
  "SNAP91", "HSP90AA1", "VPS35", "S100A9", "XRCC6", "PSMB5"
)
hubs[[3]] <- c(
  "APP", "GOT2", "SQSTM1", "WASF1", "CNTNAP1", "ATF4", "NEFM",
  "SNAP91", "HSP90AA1", "VPS35", "MEF2C"
)
...
priority_gse[[2]] <- list(
  ...
  `S100A9 Associated` = "S100A9",
  `XRCC6 Associated` = "XRCC6",
  `PSMB5 Associated` = "PSMB5"
)
priority_gse[[3]] <- list(
  `APP Associated` = "APP",
  `GOT2 Associated` = "GOT2",
...
res <- data.frame(
  `Dataset` = c("LCM Mass Spec", "FACS ssRNAseq"),
  `N Pathways Differentially Enriched` = c(n_gse[[2]], n_gse[[3]]),
  `N Genes/Proteins Differential Expressed` = c(n_deg[[2]], n_deg[[3]]),
  `N Pathways DE UP` = c(n_gse_up[[2]], n_gse_up[[3]]),
  `N Pathways DE DOWN` = c(n_gse_dn[[2]], n_gse_dn[[3]]),
  `N Genes/Proteins DE UP` = c(n_deg_up[[2]], n_deg_up[[3]]),
  `N Genes/Proteins DE DOWN` = c(n_deg_dn[[2]], n_deg_dn[[3]]),
  `N Pathways Tested` = c(nrow(res_gse[[2]]), nrow(res_gse[[3]])),
  `N Genes/Proteins Tested` = c(nrow(res_deg[[2]]), nrow(res_deg[[3]])),
  `Percentage Pathways DE` = c(
    percent(n_gse[[2]] / nrow(res_gse[[2]])),
    percent(n_gse[[3]] / nrow(res_gse[[3]]))
  ),
  `Percentage Genes/Proteins DE` = c(
...
colnames(res) <- c(
  "Dataset",
  "N Pathways Differentially Enriched",
  "N Genes/Proteins Differential Expressed",
  "N Pathways DE UP",
  "N Pathways DE DOWN",
  "N Genes/Proteins UP",
  "N Genes/Proteins DE DOWN",
  "N Pathways Tested",
  "N Genes/Proteins Tested",
  "Percentage Pathways DE",
  "Percentage Genes/Proteins DE"
)
...
### Pathway Enrichment Venn Diagram

```{r}
plot(
  euler(venn_list_gse),
  fills = list(
    fill = c("Set1" = venn_col[1], "Set2" = venn_col[2]), alpha = 0.9
  ),
  ...
  server = function (input, output, session) {
    observeEvent({
      ...
      if (input[[paste0("scaling", 211)]] == "Scaled") {
        if (length(input[[paste0("gse", 211)]]) > 0) {
          mat <- t(
            apply(
              mat, MARGIN = 1,
              FUN = function (x) ((2 * (x - min(x)) / (max(x) - min(x))) - 1)
  ...
  server = function (input, output, session) {
    observeEvent({
      ...
      if (input[[paste0("scaling", 212)]] == "Scaled") {
        if (length(input[[paste0("gse", 212)]]) > 0) {
          mat <- t(
            apply(
              mat, MARGIN = 1,
              FUN = function (x) ((2 * (x - min(x)) / (max(x) - min(x))) - 1)
  ...
  server = function (input, output, session) {
    observeEvent({
      ...
      if (input[[paste0("scaling", 213)]] == "Scaled") {
        if (length(input[[paste0("gse", 213)]]) > 0) {
          mat <- t(
            apply(
              mat, MARGIN = 1,
              FUN = function (x) ((2 * (x - min(x)) / (max(x) - min(x))) - 1)
  ...
  server = function (input, output, session) {
    observeEvent({
      ...
      if (input[[paste0("scaling", 214)]] == "Scaled") {
        if (length(input[[paste0("gse", 214)]]) > 0) {
          mat <- t(
            apply(
              mat, MARGIN = 1,
              FUN = function (x) ((2 * (x - min(x)) / (max(x) - min(x))) - 1)
  ...
  server = function (input, output, session) {
    observeEvent({
      ...
      if (input[[paste0("scaling", 215)]] == "Scaled") {
        if (length(input[[paste0("gse", 215)]]) > 0) {
          mat <- t(
            apply(
              mat, MARGIN = 1,
              FUN = function (x) ((2 * (x - min(x)) / (max(x) - min(x))) - 1)
  ...
  server = function (input, output, session) {
    observeEvent({
      ...
      if (input[[paste0("scaling", 216)]] == "Scaled") {
        if (length(input[[paste0("gse", 216)]]) > 0) {
          mat <- t(
            apply(
              mat, MARGIN = 1,
              FUN = function (x) ((2 * (x - min(x)) / (max(x) - min(x))) - 1)
  ...
  server = function (input, output, session) {
    observeEvent({
      ...
      if (input[[paste0("scaling", 217)]] == "Scaled") {
        if (length(input[[paste0("gse", 217)]]) > 0) {
          mat <- t(
            apply(
              mat, MARGIN = 1,
              FUN = function (x) ((2 * (x - min(x)) / (max(x) - min(x))) - 1)
  ...
  server = function (input, output, session) {
    observeEvent({
      ...
      if (input[[paste0("scaling", 311)]] == "Scaled") {
        if (length(input[[paste0("gse", 311)]]) > 0) {
          mat <- t(
            apply(
              mat, MARGIN = 1,
              FUN = function (x) ((2 * (x - min(x)) / (max(x) - min(x))) - 1)
  ...
  server = function (input, output, session) {
    observeEvent({
      ...
      if (input[[paste0("scaling", 312)]] == "Scaled") {
        if (length(input[[paste0("gse", 312)]]) > 0) {
          mat <- t(
            apply(
              mat, MARGIN = 1,
              FUN = function (x) ((2 * (x - min(x)) / (max(x) - min(x))) - 1)
  ...
  server = function (input, output, session) {
    observeEvent({
      ...
      if (input[[paste0("scaling", 313)]] == "Scaled") {
        if (length(input[[paste0("gse", 313)]]) > 0) {
          mat <- t(
            apply(
              mat, MARGIN = 1,
              FUN = function (x) ((2 * (x - min(x)) / (max(x) - min(x))) - 1)
...
shinyApp(
  ...
  ui = fluidPage(
    ...
    fluidPage(
      div(
        style = "display:flex;",
        plotOutput("heatmap2", height = "670px"),
...
shinyApp(
  ...
  ui = fluidPage(
    ...
    fluidPage(
      div(
        style = "display:flex;",
        plotOutput("heatmap3", height = "670px"),
...
shinyApp(
  ...
  ui = fluidPage(
    ...
    fluidPage(
      div(
        style = "display:flex;",
        plotOutput("heatmap2c", height = "670px"),
        plotOutput("heatmap3c", height = "670px")
      )
    )
  ),
