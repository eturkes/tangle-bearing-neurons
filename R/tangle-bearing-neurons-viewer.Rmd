...
shinyApp(
  ...
  ui = fluidPage(
    ...
    fluidRow(
      ...
      column(
        width = 1,
        actionButton(paste0("init_up", 2), label = "Initialise"),
...
shinyApp(
  ...
  ui = fluidPage(
    ...
    fluidRow(
      ...
      column(
        width = 1,
        actionButton(paste0("init_dn", 2), label = "Initialise"),
        style = "padding-top: 35px;"
      )
    ),
...
shinyApp(
  ...
  ui = fluidPage(
    ...
    fluidRow(
      ...
      column(
        width = 1,
        actionButton(paste0("init_up", 3), label = "Initialise"),
        style = "padding-top: 35px;"
      )
    ),
...
shinyApp(
  ...
  ui = fluidPage(
    ...
    fluidRow(
      ...
      column(
        width = 1,
        actionButton(paste0("init_dn", 3), label = "Initialise"),
        style = "padding-top: 35px;"
      )
    ),
...
shinyApp(
  ...
  ui = fluidPage(
    ...
    fluidRow(
      ...
      column(
        width = 1,
        actionButton(paste0("init_up", 23), label = "Initialise"),
        style = "padding-top: 35px;"
      ),
      column(
        width = 2,
...
shinyApp(
  ...
  ui = fluidPage(
    ...
    fluidRow(
      ...
      column(
        width = 1,
        actionButton(paste0("init_dn", 23), label = "Initialise"),
        style = "padding-top: 35px;"
      ),
      column(
        width = 2,
...
shinyApp(
  ...
  ui = fluidPage(
    ...
    fluidRow(
      ...
      column(
        width = 1,
        actionButton(paste0("init", "_deg"), label = "Initialise"),
...
rm(
  ...
  add_anno, add_anno2, add_anno3, gene_anno_sub2, gene_anno_sub3
)
gc()
```
