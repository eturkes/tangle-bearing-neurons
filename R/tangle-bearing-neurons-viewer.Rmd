...
shinyApp(
  ...
  ui = fluidPage(
    ...
    InteractiveComplexHeatmapOutput(
      heatmap_id = paste0("ht", comb_idx), response = "click",
      title1 = "Click Row to See Proteins", title2 = NULL, title3 = NULL,
      width1 = 1200, height1 = 600, compact = TRUE
    )
  ),
  ...
  server = function (input, output, session) {
    observeEvent({
      ...
      if (input[[paste0("scaling", 11)]] == "Scaled") {
        ...
        title <- paste0("Scaled ", data_types[1 + 2])
      } else {
        col <- colorRamp2(range_gse[[1]], colors = c("blue", "white", "red"))
        title <- data_types[1 + 2]
      }
      ...
      makeInteractiveComplexHeatmap(
        input, output, session, ht, res = 96, heatmap_id = paste0("ht", 11)
      )
    })
  },
)
...
shinyApp(
  ...
  server = function (input, output, session) {
    observeEvent({
      ...
      makeInteractiveComplexHeatmap(
        input, output, session, ht, res = 96, heatmap_id = paste0("ht", 12)
      )
    })
  },
)
