  ...
  server = function (input, output, session) {
    observeEvent({
      ...
      if (length(names(V(graph))) > 0) {
        ...
        vis_up <- visInteraction(
          vis_up,
          tooltipStyle =
            "width: max-content;position: fixed;visibility:hidden;padding: 5px;white-space: nowrap;font-family: verdana;font-size:14px;font-color:#000000;background-color: #ffffff;-moz-border-radius: 3px;-webkit-border-radius: 3px;border-radius: 3px;border: 1px solid #808074;box-shadow: 3px 3px 10px rgba(0, 0, 0, 0.2);"
        )
      }
...
rm(
  ...
  gene_anno_sub2c, gene_anno_sub3c, gene_sets_sub, res_gse_fmt
)
gc()
```
